...
// curl -X POST -H "X-Parse-Application-Id: ZwqdQKWXjs4vs9n22rqL0gQA0mBoFCooSMtA7BBG" -H "X-Parse-REST-API-Key: wo2DAtaAaQ2CdzTWuM07oChzxmOSb8kMwi2wHRG7" -H "Content-Type: application/json"  -d "{\"objectId\":\"N069yaMv1E\"}" https://api.parse.com/1/functions/confirmPhone
...
//curl -X POST -H "X-Parse-Application-Id: ZwqdQKWXjs4vs9n22rqL0gQA0mBoFCooSMST-API-Key: wo2DAtaAaQ2CdzTWuM07oChzxmOSb8kMwi2wHRG7" -H "Content-Type: application/json"  -d "{\"objectId\":\"oixOvVCqPD\", \"confirmationCode\":\"1111\"}" https://api.parse.com/1/functions/authenticateConfirmation 
